package com.javastart.optional.contacts;
...
//                .findFirst()
//                .orElseThrow( () -> new NullPointerException("email cannot be null"));
    }

    Optional<List<Contact>> findByLastName(String textFragment) {
